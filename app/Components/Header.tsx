...
const Header = () => {
  return (
    <nav className="sticky mx-auto text-light-Accent dark:text-dark-Accent  flex justify-center  top-0 left-0 right-0 z-10 backdrop-blur border-b border-primary dark:border-primary-400">
